...
# wget https://raw.githubusercontent.com/villcabo/bash-setup/main/bash_configuration/bash_full.sh -O ~/.bashrc
# source ~/.bashrc
#
# COMPATIBILITY:
# - Bash 4.0+
...
bashrc_help() {
  ...
  echo -e "    ${CYAN}wget https://raw.githubusercontent.com/villcabo/bash-setup/main/bash_configuration/bash_full.sh -O ~/.bashrc${RESET}"
